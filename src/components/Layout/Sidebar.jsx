...
function Sidebar(props) {
  ...
  return (
    <div className={`w-[300px] h-[calc(90%)] border-t-0 border fixed left-0 top-20 p-6 sm:block z-[2] bg-white sidebar transition-all duration-300 shrink-0 ${navbar ? "block" : "hidden"}`}>
      ...
      <div className='absolute bottom-0 w-4/5'>
        ...
        <div className='justify-between flex p-3 my-3'>
          <div>
            ...
            <span className='absolute rounded-full bg-[#F6F6F6] w-8 h-8 left-12 text-center pt-1 text-[14px] text-[#6E7B91] font-[500]'>+3</span>
          </div>
          <div className='border border-slate-300 rounded-lg px-4 py-2 cursor-pointer text-[#6E7B91] hover:text-[#6823D0] hover:bg-[#F1EAFB] font-[500]'>Invite <i className='fa fa-user-plus'></i></div>
        </div>
      </div>
