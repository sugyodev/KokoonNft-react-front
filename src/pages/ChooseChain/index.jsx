      ...
      <div className='mt-24'>
        <div className='text-center'>
          <div className='w-[370px] m-auto'>
            ...
            <p className='my-2 text-sm text-center text-[#303C4F]'>Select the blockchain where you'd like new items from this collection to be added by default.</p>
          </div>

          <div className='grid lg:grid-cols-4 md:grid-cols-2 md:grid-cols-1 lg:w-3/5 mx-auto mt-10 border-0 gap-3 text-center'>
            <div onClick={() => { selectChain('ethereum') }} className='border sm:w-full mx-2 border-[#F0F2F4] h-fit rounded-lg my-1 py-6 pb-8 px-4 hover:border-[#6823d0] cursor-pointer text-center'>
              <img src='imgs/eth-icon.png' className='mx-auto my-3' />
              <h3 className='text-center font-bold text-[#000549]'>Ethereum</h3>
            </div>
            ...
            <div onClick={() => { selectChain('solana') }} className='border sm:w-full mx-2 border-[#F0F2F4] h-fit rounded-lg my-1 py-6 pb-8 px-4 hover:border-[#6823d0] cursor-pointer'>
              <img src='imgs/solana-icon.png' className='mx-auto my-3' />
            ...
            <div onClick={() => { selectChain('tezos') }} className='border sm:w-full mx-2 border-[#F0F2F4] h-fit rounded-lg my-1 py-6 pb-8 px-4 hover:border-[#6823d0] cursor-pointer'>
              <img src='imgs/tezos-icon.png' className='mx-auto my-3' />
            ...
            <div onClick={() => { selectChain('polygon') }} className='border sm:w-full mx-2 border-[#F0F2F4] h-fit rounded-lg my-1 py-6 pb-8 px-4 hover:border-[#6823d0] cursor-pointer'>
              <img src='imgs/polygon-icon.png' className='mx-auto my-3' />
